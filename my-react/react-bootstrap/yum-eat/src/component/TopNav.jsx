...
export default function TopNav() {
  ...
  return (
        ...
        <button className='bg-orange-700 md:flex items-center  text-white hidden py-2 rounded-full'>
       ...
       'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
        ...
        <nav>
            <ul className='flex flex-col p-4 text-gray-900'>
                ...
                <li className='text-xl py-4 flex'><MdOutlineFavorite size={25} className='mr-4 text-white bg-black rounded-full'/>My Favorite</li>
